...
#
# Generated by export_simulation on Tue Dec 09 09:36:32 +0100 2025
#
################################################################################
...
'-reset_run' switch to the './raw_data_fifo_k160.sh' script.

./raw_data_fifo_k160.sh -reset_run
...
./raw_data_fifo_k160.sh -noclean_files

For more information on the script, please type './raw_data_fifo_k160.sh -help'.
