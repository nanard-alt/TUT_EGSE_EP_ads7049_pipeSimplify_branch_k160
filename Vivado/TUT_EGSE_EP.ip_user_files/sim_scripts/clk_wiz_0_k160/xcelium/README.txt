...
#
# Generated by export_simulation on Tue Dec 09 08:28:39 +0100 2025
#
################################################################################
...
'-reset_run' switch to the './clk_wiz_0_k160.sh' script.

./clk_wiz_0_k160.sh -reset_run
...
./clk_wiz_0_k160.sh -noclean_files

For more information on the script, please type './clk_wiz_0_k160.sh -help'.
